...
const en = {
  ...
  priceVersionHelp: "Choose an item and market, then enter the normal amount in PLN or EUR. The system stores it safely as a versioned price.", stripeHelp: "Leave both Stripe fields empty to create a test Product and Price automatically. Publish the draft only after checking the amount and currency.",
...
const pl: Record<AdminTextKey, string> = {
  ...
  priceVersionHelp: "Wybierz pozycję i rynek, a następnie wpisz zwykłą kwotę w PLN lub EUR. System bezpiecznie zapisze ją jako wersjonowaną cenę.", stripeHelp: "Zostaw oba pola Stripe puste, aby automatycznie utworzyć testowy Product i Price. Opublikuj szkic dopiero po sprawdzeniu kwoty i waluty.",
