...
const en = {
  ...
  createPriceVersion: "Set a plan or add-on price", plan: "Plan", addon: "Add-on", itemId: "Plan or add-on", offerType: "Offer type", marketAndCurrency: "Market and currency", paymentSchedule: "Payment schedule", netAmount: "Net amount", amountExample: "For example 359.00", createDraftPrice: "Save draft price",
  priceVersionHelp: "Choose an item and market, then enter the normal amount in PLN or EUR. The system stores it safely as a versioned price.", stripeHelp: "Paste the matching test-mode Stripe IDs. Publish the draft only after checking the amount and currency.",
...
const pl: Record<AdminTextKey, string> = {
  ...
  createPriceVersion: "Ustaw cenę planu lub dodatku", plan: "Plan", addon: "Dodatek", itemId: "Plan lub dodatek", offerType: "Rodzaj oferty", marketAndCurrency: "Rynek i waluta", paymentSchedule: "Sposób rozliczenia", netAmount: "Kwota netto", amountExample: "Na przykład 359,00", createDraftPrice: "Zapisz szkic ceny",
  priceVersionHelp: "Wybierz pozycję i rynek, a następnie wpisz zwykłą kwotę w PLN lub EUR. System bezpiecznie zapisze ją jako wersjonowaną cenę.", stripeHelp: "Wklej odpowiadające identyfikatory Stripe z trybu testowego. Opublikuj szkic dopiero po sprawdzeniu kwoty i waluty.",
