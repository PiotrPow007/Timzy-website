...
const consentModeScript = `window.dataLayer = window.dataLayer || [];
...
export function GoogleTagManagerHead() {
  return <>
    <script id="google-consent-mode" dangerouslySetInnerHTML={{ __html: consentModeScript }} />
    <script id="google-tag-manager" dangerouslySetInnerHTML={{ __html: tagManagerScript }} />
  </>;
}
